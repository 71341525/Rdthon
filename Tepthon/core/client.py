                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @r_32i\
                                  \n\n--------بـدء تتبـع سجـل ردثـون 𝗥𝗱𝘁𝗵𝗼𝗻--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ردثـون 𝗥𝗱𝘁𝗵𝗼𝗻--------"
                        ...
                        link = "[غـازي](https://t.me/r_32i)"
                        text = (
                            "**✘ تقـريـر إشعـار ردثـون 𝗥𝗱𝘁𝗵𝗼𝗻 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار ردثـون 𝗥𝗱𝘁𝗵𝗼𝗻 ✘**\n\n "
                        link = "[غـازي](https://t.me/r_32i)"
