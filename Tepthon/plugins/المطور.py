...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗥𝗱𝘁𝗵𝗼𝗻 𓆪 </b> - @A0R01 "
...
async def who(event):
    ...
    if replied_user.id == 7177826212 or replied_user.id == 7177826212 or replied_user.id == 7177826212:
