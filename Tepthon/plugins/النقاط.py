...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗱𝘁𝗵𝗼𝗻 - أوامـر تجميـع النقـاط](t.me/A0R01) 𓆪\n\n"
    "**⎉╎قـائمـة أوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس ردثـون🦾 :** \n\n"
    "`.المليار`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- ملاحظـة :**\n"
    "**⪼ سيتم إضـافـة المزيـد من البوتـات بالتحديثـات القادمـة .. اذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @r_32i**"
)
