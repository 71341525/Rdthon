...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗱𝘁𝗵𝗼𝗻 - أوامـر الصيد والتشيكـر](t.me/A0R01) 𓆪\n\n"
    ...
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن ريدثون**\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗱𝘁𝗵𝗼𝗻 - أنـواع اليـوزرات](t.me/A0R01) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد ريدثون A0R01 ⎉",

                    about="This channel to hunt username by - @A0R01 ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت ريدثون 𝗥𝗱𝘁𝗵𝗼𝗻 ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس تيبثـــون - @A0R01 ",
