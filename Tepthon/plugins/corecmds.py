...
async def install(event):
    ...
    zed_dev = (7177826212, 7177826212, 7177826212, 7177826212, 7177826212)
...
async def load(event):
    ...
    zelzal = event.sender_id
    zed_dev = (7177826212, 7177826212, 5176749470, 5280339206, 5992422584)
    if zelzal not in zed_dev:
        return await edit_delete(event, "**- عـذࢪاً .. عـزيـزي ؟!**\n**- هـذا الامـࢪ خاص بمطـوࢪ السـوࢪس**", 10)
...
async def unload(event):
    ...
    zelzal = event.sender_id
    zed_dev = (7177826212, 7177826212, 7177826212, 5280339206, 5992422584)
    if zelzal not in zed_dev:
        return await edit_delete(event, "**- عـذࢪاً .. عـزيـزي ؟!**\n**- هـذا الامـࢪ خاص بمطـوࢪ السـوࢪس**", 10)
    shortname = event.pattern_match.group(1)
