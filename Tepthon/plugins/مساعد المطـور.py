...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗱𝘁𝗵𝗼𝗻 - اوامــر المطـور المســاعد](t.me/A0R01) 𓆪\n\n"
    ...
    "\n𓆩 [ 𝗥𝗱𝘁𝗵𝗼𝗻 - مطـور السـورس](t.me/r_32i) 𓆪"
)
...
async def _(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت ريدثون 𝗥𝗱𝘁𝗵𝗼𝗻 انتظـر 2-1 دقيقـه ▬▭ ...**"
    msg = await edit_or_reply(event, output)
    await event.client.reload(msg)
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗥𝗱𝘁𝗵𝗼𝗻 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت ريدثون 𝗥𝗱𝘁𝗵𝗼𝗻 انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
